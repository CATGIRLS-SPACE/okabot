...
export enum LANG_INTERACTION {
    ...
    DAILY_REMINDER_SCHEDULED_KROWNED = 'interaction.daily.reminder.scheduledtk',
...
const LANGUAGE_EN: Language = {
    ...
    'interaction.daily.reminder.scheduledtk': `${GetEmoji(EMOJI.CAT_SUNGLASSES)} Yes master, I'll ping you in this channel when your daily is ready!`,
...
const LANGUAGE_JA: Language = {
    ...
    'interaction.daily.reminder.scheduledtk': `${GetEmoji(EMOJI.CAT_SUNGLASSES)} は～い、マスター！日次報酬は整うとメンションしましょう！`,
